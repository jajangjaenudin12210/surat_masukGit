      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form action="/ubahSuratMasuk/{{ $dataSM->id_surat_masuk }}" method="post" role="form" enctype="multipart/form-data">
                  <div class="modal-body">  
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control asal_surat_masuk" id="u_asal_surat_masuk" name="u_asal_surat_masuk" value="{{ $dataSM->asal_surat_masuk }}">
                      </div>
                      <div class="form-group">
                        <label for="recipient-name" class="col-form-label">Nomor Surat:</label>
                        <input type="text" class="form-control no_surat_masuk" id="u_no_surat_masuk" name="u_no_surat_masuk" value="{{ $dataSM->no_surat_masuk }}">
                      </div>
                      <div class="form-group">
                        <label for="recipient-name" class="col-form-label">Tanggal Surat:</label>
                        <input type="date" class="form-control tgl_surat_masuk" id="u_tgl_surat_masuk" name="u_tgl_surat_masuk" value="{{ $dataSM->tgl_surat_masuk }}">

                      </div>
                      <div class="form-group">
                        <label for="message-text" class="col-form-label">Perihal</label>
                        <textarea class="form-control perihal_surat_masuk" id="u_perihal_surat_masuk" name="u_perihal_surat_masuk"><?php echo $dataSM['perihal_surat_masuk']?></textarea>
                      </div>
                      <div class="form-group">
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="date" class="form-control tgl_terima" id="u_tgl_terima" name="u_tgl_terima" value="{{ $dataSM->tgl_terima }}">
                      </div>
                      <div class="form-group">
                        <label for="recipient-name" class="col-form-label">Nomor Agenda:</label>
                        <input type="number" class="form-control no_agenda" id="u_no_agenda" name="u_no_agenda" value="{{ $dataSM->no_agenda }}">
                      </div>
                      <div class="form-group">
                  ...
                  <div class="modal-footer">
                    <a href="/tambahSurat"><button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button></a>
